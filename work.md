	...
	<div class="table-wrapper">
		<table>
			...
			<tbody>
				...
				<tr>
					<td>Machine Learning: Apprentissage Supervisé</td>
					<td> Classification des habitants aux Etats-Unis suivant leur revenu annuel </td>
        		...
        		<tr>
					<td>Web Scraping</td>
					<td>Création d'un agrégateur d'articles : pour un mot donné, scrapping d'articles issus des pages de résultats de recherche de deux médias</td>
